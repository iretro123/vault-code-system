  ...
  return (
    <>
      <div className="flex flex-col h-full overflow-hidden bg-background">
        ...
        <div className="flex flex-col flex-1 <div className="flex flex-col flex-1 m-3 rounded-2xl overflow-hidden border border-white/[0.05] bg-card shadow-[0_6px_32px_rgba(0,0,0,0.35)]"> rounded-2xl overflow-hidden border border-white/[0.05] bg-card shadow-[0_6px_32px_rgba(0,0,0,0.35)]">
