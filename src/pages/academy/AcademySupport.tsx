  ...
  return (
    <div className="flex flex-col items-center w-full max-w-3xl mx-auto px-4 py-10 md:py-16">
      ...
      <div className="mt-8 max-w-xl text-center space-y-4 text-sm md:text-base text-muted-foreground leading-relaxed">
        <p>
          These individual calls are designed to help you get the most out of <span className="text-muted-foreground font-semibold">Vault</span><span className="text-primary/70 font-semibold">OS</span> and move with clarity.
