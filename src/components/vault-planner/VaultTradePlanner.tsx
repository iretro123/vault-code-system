    ...
    >
      ...
      <XPFieldset legend="1) Account">
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <XPInput label="Risk %" type="number" step="0.1" value={riskPercent} onChange={(e) => setRiskPercent(e.target.value)} error={errors.riskPercent} />
          <XPInput label="Debit Cap %" type="number" step="0.1" value={debitCapPercent} onChange={(e) => setDebitCapPercent(e.target.value)} error={errors.debitCapPercent} />
        </div>
      ...
      <XPFieldset legend="2) Trade">
        ...
        <div className="grid grid-cols-2 gap-2">
          <XPInput label="Entry Price (Option)" type="number" step="0.01" value={entryPremium} onChange={(e) => setEntryPremium(e.target.value)} error={errors.entryPremium} placeholder="$0.80" />
          <XPInput label="Cut Loss At (Option)" type="number" step="0.01" value={stopPremium} onChange={(e) => setStopPremium(e.target.value)} error={errors.stopPremium} placeholder="$0.40" />
        </div>
        <p className="text-[10px] text-muted-foreground">This is your stop loss on the option.</p>
        <div className="grid grid-cols-3 gap-2">
          <XPInput label="RR" value="1:2" readOnly style={{ opacity: 0.7 }} />
          <XPInput label="TP1 %" type="number" value={tp1} onChange={(e) => setTp1(e.target.value)} />
          <XPInput label="TP2 %" type="number" value={tp2} onChange={(e) => setTp2(e.target.value)} />
        </div>
        ...
        {showMore && (
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 pt-1">
            <XPInput label="DTE" type="number" value={dte} onChange={(e) => setDte(e.target.value)} placeholder="30" />
            <XPInput label="Delta" type="number" step="0.01" value={delta} onChange={(e) => setDelta(e.target.value)} placeholder="0.40" />
        ...
        <p className="text-[10px] text-muted-foreground">Optional: DTE • Delta • Strike • Chart stop level</p>
      </XPFieldset>
