...
export function CommunityTradeFloor() {
  ...
  return (
    <div className="flex h-full overflow-hidden bg-[hsl(220,14%,94%)]">
      {/* Primary Feed — 70% */}
      ...
      {!isMobile && (
        <div className="w-[280px] shrink-0 border-l border-[hsl(220,12%,85%)] hidden lg:flex flex-col bg-[hsl(220,12%,91%)]">
          <CockpitPanel />
        </div>
      )}
