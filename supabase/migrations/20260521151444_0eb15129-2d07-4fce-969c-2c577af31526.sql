...
DROP POLICY IF EXISTS "Operators can manage content reports" ON public.content_reports;
...
DROP POLICY IF EXISTS "Operators can view user blocks" ON public.user_blocks;
