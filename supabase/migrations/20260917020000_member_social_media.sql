-- Apply after member_messaging; staging verification required before release.
...
INSERT INTO storage.buckets(id,name,public,file_size_limit,allowed_mime_types)
 VALUES('vault-member-files','vault-member-files',false,15728640,ARRAY['image/png','image/jpeg','image/gif','image/webp','application/pdf','video/mp4']);
...
-- Also constrain any older broad storage policies: unrelated buckets retain their existing behavior.
