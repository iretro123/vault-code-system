-- Member-to-member messaging (separate from existing staff inbox; staff dm_threads untouched)
...
GRANT ALL ON public.member_conversations, public.member_messages, public.member_message_blocks TO service_role;
